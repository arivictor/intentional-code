...
First, what makes a URL shortener the ideal first production service — and what "production-ready" actually demands, property by property. Then the decision everything else rests on: splitting the system into three independent concerns so that swapping a code-generation strategy never touches your storage, and swapping storage never touches your HTTP layer.
