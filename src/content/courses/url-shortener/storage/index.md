...
title: "Storage"
order: 3
description: "Fill the Store hole three times: an in-memory Repository, a durable append-only file, and a caching Decorator that wraps either — all behind one interface."
---
