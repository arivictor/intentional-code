...
const SLUG = "solid";
const TITLE = "SOLID Principles";
const DESCRIPTION = "How the five SOLID principles apply in Go — where they're free by default and where they need deliberate effort.";
