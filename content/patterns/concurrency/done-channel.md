---
title: "Done Channel"
description: "Signal goroutines to stop work by closing a shared channel or cancelling a context, preventing goroutine leaks."
---
...
```go:title="done-channel.go":run=true:editable=true
package main
...
```go:title="context.go":run=true:editable=true
package main
