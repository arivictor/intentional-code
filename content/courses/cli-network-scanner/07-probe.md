...
This is the [Strategy pattern](/go/patterns/behavioral/strategy) in its minimal form — but we're not introducing it to vary behaviour at runtime. We're introducing it so that tests don't touch the network.
